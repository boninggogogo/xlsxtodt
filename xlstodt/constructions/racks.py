...
from xlstodt.utils import get_cell_value, get_model_value, random_int, random_server_name
...
def write_server(server_sheet: Any, all_data: dict, col_indices: dict, servers_count: int):
    ...
    for row_idx, row in enumerate(server_sheet.iter_rows(min_row=2, min_col=col_indices['server_rack'][0],
        ...
        min_range = 1
        slots = random_int(number=servers_count, number_range=[min_range, max_range])
